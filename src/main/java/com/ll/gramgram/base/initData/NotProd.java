...
public class NotProd {
    ...
    CommandLineRunner initData(
        ...
        return args -> {
            ...
            Member memberUser5ByKakao = memberService.whenSocialLogin("KAKAO", "KAKAO__2745252925").getData();
            Member memberUser6ByGoogle = memberService.whenSocialLogin("GOOGLE", "GOOGLE__114358155992459572799").getData();
